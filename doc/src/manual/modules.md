...
brings *only* the module name into scope. Users would need to use `NiceStuff.Dog` and `NiceStuff.nice` to access its contents. Usually, `import ModuleName` is used in contexts when the user wants to keep the namespace clean.
